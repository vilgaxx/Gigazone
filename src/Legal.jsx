        ...
        <div className="container">
          ...
          <div className="text-center">
            ...
            <p className="py-6  w-full mx-auto text-justify">
              ...
              unauthorized parties during or after transmission. Similarly, when
              we send a message to a third party at the request of the user or
              as part of the Service, we also cannot guarantee that the
              information contained in that message will not be intercepted by,
            ...
            <p className="py-6  w-full mx-auto text-justify">
              ...
              disclose personal information when required by law or in any other
              situation wherein we have a bonafide belief that such action is
            ...
            <p className="py-6  w-full mx-auto text-justify">
              ...
              the above terms and conditions in addition to all terms and
            ...
            <p className="py-6  w-full mx-auto text-justify">
              ...
              that children face online. Working together, we can make the
              online environment a safe and rewarding experience for children.
              Filtering software like CYBERPATROL, NETNANNY, SURFWATCH, etc.,
              can help keep children from inappropriate online areas. Like the
            ...
            <h1 className="text-4xl font-bold uppercase z-50">
            ...
            <p className="py-6  w-full mx-auto text-justify">
              ...
              of the Company. The Company may combine information about you that
              we have with information we obtain from business partners or other
              ...
              to you. When you register, we ask for information such as your
              name, email address, birth date, gender, zip code, occupation,
              industry, and personal interests. Once you register with the
              Company and sign in to our services, you become our valued
              customer. The Company collects information about your transactions
              with us and with some of our business partners, including
              information about your use of products and services that we offer.
              The Company can use information for the following general
              purposes: to customize the advertising and content you see,
              fulfill your requests for products and services, improve our
              services, contact you, conduct research, and provide anonymous
              reporting for internal and external clients. Information Sharing
              and Disclosure We provide the information to trusted partners who
              work on behalf of or with the Company under confidentiality
              agreements. These companies may use your personal information to
              help the Company communicate with you about offers from the
              Company and our marketing partners.
              <br />
              ...
              ads meet the targeting criteria, for example, women ages 18-24
              from a particular geographic area.
              <br />
              The Company will not provide any personal information to the
              advertiser when you interact with or view a targeted ad. However,
